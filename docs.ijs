NB. JOD dictionary dump: 23 Aug 2011 15:54:09
...
NB. check for any blanks in file/path names 
NB. blanks are a goddamn nuisance and 
NB. will not be tolerated - suck on it people!
nbibs=. ('}'&beforelaststr&.> fmsk # bibs) ,&.> ','

NB. insert qualified NOTE file macros escaping
NB. all the url blanks and other irritants
NB. files=.  '# #%20'&changestr&.> files
